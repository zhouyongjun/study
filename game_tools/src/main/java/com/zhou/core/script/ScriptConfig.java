...
public class ScriptConfig {
	...
	public static void loadProperties() {
		...
		String fileName = ScriptConfig.class.getClassLoader().getResource(ToolsConfig.SCRIPT_FILE_NAME).getPath();
		try
		{
	...
	public void unload() {
		PrintWriter pw = null;
		try {
			String fileName = ScriptConfig.class.getClassLoader().getResource(ToolsConfig.WEB_CONFIG_FILE_NAME).getPath();
